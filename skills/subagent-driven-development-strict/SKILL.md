---
name: subagent-driven-development-strict
description: Use when executing implementation plans with independent tasks in the current session and you want the original two-stage review workflow
---
...
digraph when_to_use {
    ...
    "subagent-driven-development-strict" [shape=box];
    "executing-plans-strict" [shape=box];
    ...
    "Stay in this session?" -> "subagent-driven-development-strict" [label="yes"];
    "Stay in this session?" -> "executing-plans-strict" [label="no - parallel session"];
}
```
...
- **superpowers:writing-plans-strict** - Creates the strict plan this skill executes
...
- **superpowers:executing-plans-strict** - Use for parallel session instead of same-session execution
